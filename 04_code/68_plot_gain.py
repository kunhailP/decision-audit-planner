...
ax.set_ylabel(f"PPI effective-sample-size gain at T={T_PLOT} (cross-fit λ)")
...
fig.savefig(os.path.join(root, f"F4_gain_vs_rho_T{T_PLOT}.png"), dpi=160)
